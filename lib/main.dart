...
import 'features/employee/presentation/manager/cubit/search_cubit.dart';
...
import 'features/payroll/presentation/pages/add_payroll.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
            create: (_) =>
                di.sl<GetAllEmployeesBloc>()..add(const GetEmployeesEvent())),
        BlocProvider(
            create: (_) =>
                di.sl<GetPayrollsBloc>()..add(const GetAllPayrollsEvent())),
        BlocProvider(create: (_) => di.sl<AddUpdatePayrollBloc>()),
        BlocProvider(create: (_) => di.sl<SearchCubit>())
      ],
      child: GetMaterialApp(
        title: 'Flutter Demo',
        theme: appTheme,
        home: const AddEmployeeParoll(),
      ),
    );
  }
}
